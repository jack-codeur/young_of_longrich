                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="product-info">
                                <h2 class="title">Aller pour la promo du Camera Drone</h2>
                                <p class="category"><i class="lni lni-tag"></i>Nom_type_article:<a href="javascript:void(0)">Nom_propriété_article</a></p>
