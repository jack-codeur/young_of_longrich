                            ...
                            <table class="table around app-table-hover mb-0 text-left">
                                <thead style="background-color: rgb(59, 85, 202);">
                                    <tr>
                                        ...
                                        <th style="color: white;" class="cell">Publié Il y a</th>
                                ...
                                <tbody>
                                    @foreach ($santes as $sante)
                                        @if ( $sante->id_typeArticle == 1 )
                                            <tr>
                                                <td class="cell">#{{$sante->id}}</td>
                                                <td class="cell"><span class="truncate">{{$sante->nom_article}}</span></td>
                                                <td class="cell">{{$sante->id_typeArticle}}</td>
                                                <td class="cell"><span class="note">{{$sante->titre_article}}</span></td>
                                                <td class="cell"><span>{{$sante->prix_article}}</span></td>
                                                <td class="cell">{{$sante->created_at}}</td>
                                                <td class="cell">
