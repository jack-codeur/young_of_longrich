                    ...
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <div class="app-search-box col">
                            <form class="app-search-form">   
                                <input wire:model.debounce.700ms="search" type="text" placeholder="Search..." name="search" class="form-control search-input">
                            ...
                            <table class="table around app-table-hover mb-0 text-left">
                                <thead style="background-color: rgb(59, 85, 202);">
                                    <tr>
                                        ...
                                        <th style="color: white;" class="cell">Durée de pub</th>
                                        <th style="color: white;" class="cell">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($accessoires as $accessoire)
                                        @if ( $accessoire->id_typeArticle == 6 )
                                            @foreach ($accessoires as $accessoire)
                                                <tr>
                                                <td class="cell">#{{$accessoire->id}}</td>
                                                <td class="cell">{{$accessoire->id_typeArticle}}</td>
                                                <td class="cell">{{$accessoire->roleOuSerie}}</td>
                                                <td class="cell"><span>{{$accessoire->prix_article}}</span></td>
                                                <td class="cell">{{$accessoire->created_at}}</td>
                                                <td class="cell">
                                ...
                                <div class="app-card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="mb-3 col-12">
                                            <label for="setting-input-1" class="form-label">caractéristique</label>
                                            <textarea class="form-control" id="setting-textarea-2" row="3" placeholder="Decrivez-le..."></textarea>
                                        </div>
                                    </div>
                                    {{-- <div class="row mb-3">
                                        <div class="mb-3 col-12">
