                        ...
                        <div class="table-responsive">
                            <table class="table app-table-hover mb-0 text-left">
                                <thead style="background-color: rgb(59, 85, 202);">
                                    <tr>
                                        <th style="color: white;" class="cell">N°Commande</th>
                                        <th style="color: white;" class="cell">Nom du client</th>
                                ...
                                <tbody>
                                    @foreach ($commandes as $commande)
                                        ...
                                        <th class="cell">{{$commande->id_client}}</th>
                                        <td class="cell">{{$commande->id_article}}</td>
                                        <td class="cell">{{$commande->id}}</td>
                                        <td class="cell">{{$commande->nmbreCommande}}</td>
                                        <td class="cell">{{$commande->id}}</td>
                                        <td class="cell">{{$commande->id}}</td>
                                        <td class="cell">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Créer une commande</h5>
