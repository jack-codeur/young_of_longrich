<div class="app-content p-md-3 p-lg-4 py-3">
        ...
        @include('livewire.admin.create_form.create_prdt_soins')
                ...
                <div class="card">
                    <div class="card-header bg-blue d-flex align-items-center">
                        ...
                        <div class="card-tools d-flex align-items-center">
                            ...
                            <button class="btn text-white mr-4 d-block" wire:click="showAddprdtSoins" style="background-color: rgb(59, 85, 202);">Créer un produit</button>
                    ...
                    <div class="card-body table-responsive p-0" style="height: 300px;">
                        <table class="table table-head-fixed text-nowrap table-striped">
                            ...
                            <tbody>
                            @foreach ($_soins as $soins )
                                @if ($soins->id_typeArticle == 2)
                                    <tr>
                                        <td class="text-center">{{$soins->id}}</td>
                                        <td class="text-center">{{$soins->id_typeArticle}}</td>
                                        <td class="text-center">{{$soins->nom_produit}}</td>
                                        <td class="text-center">{{$soins->prix_reel}}</td>
                                        <td class="text-center">{{$soins->prix_promo}}</td>
                                        <td class="text-center">{{$soins->created_at}}</td>
