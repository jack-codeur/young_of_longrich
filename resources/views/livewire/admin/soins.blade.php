        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">
                    ...
                    </span>Produits de soins et beauté
                </h1>
            </div>
            <div class="col-auto">
                                ...
                                <tbody>
                                    @foreach ($_soins as $soins)
                                        @if ( $soins->id_typeArticle == 2 )
                                            <tr>
                                                <td class="cell">#{{$soins->id}}</td>
                                                <td class="cell"><span class="truncate">{{$soins->nom_article}}</span></td>
                                                <td class="cell">{{$soins->id_typeArticle}}</td>
                                                <td class="cell"><span class="note">{{$soins->titre_article}}</span></td>
                                                <td class="cell"><span>{{$soins->prix_article}}</span></td>
                                                <td class="cell">{{$soins->created_at}}</td>
                                                <td class="cell">
