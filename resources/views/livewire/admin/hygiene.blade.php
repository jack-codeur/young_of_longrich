<div class="app-content p-md-3 p-lg-4 py-3">
        ...
        @include('livewire.admin.create_form.create_prdt_hygiene')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-blue d-flex align-items-center">
                        <h3 class="card-title flex-grow-1">Liste des produits de soins et hygiène</h3>
                        <div class="card-tools d-flex align-items-center">

                            <button class="btn text-white mr-4 d-block" wire:click="showAddPrdtHygiene" style="background-color: rgb(59, 85, 202);">Créer un produit</button>
                    ...
                    <div class="card-body table-responsive p-0" style="height: 300px;">
                        <table class="table table-head-fixed text-nowrap table-striped">
                            ...
                            <tbody>
                            @foreach ($hygienes as $hyg )
                                @if ($hyg->id_typeArticle == 3)
                                    <tr>
                                        <td class="text-center">{{$hyg->id}}</td>
                                        <td class="text-center">{{$hyg->id_typeArticle}}</td>
                                        <td class="text-center">{{$hyg->nom_produit}}</td>
                                        <td class="text-center">{{$hyg->prix_reel}}</td>
                                        <td class="text-center">{{$hyg->prix_promo}}</td>
                                        <td class="text-center">{{$hyg->created_at}}</td>
