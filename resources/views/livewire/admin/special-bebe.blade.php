                            ...
                            <table class="table around app-table-hover mb-0 text-left">
                                ...
                                <tbody>
                                    @foreach ($prduit_bebe as $bebe)
                                        @if ( $bebe->id_typeArticle == 5 )
                                            <tr>
                                                <td class="cell">#{{$bebe->id}}</td>
                                                <td class="cell"><span class="truncate">{{$bebe->nom_article}}</span></td>
                                                <td class="cell">{{$bebe->id_typeArticle}}</td>
                                                <td class="cell"><span class="note">{{$bebe->titre_article}}</span></td>
                                                <td class="cell"><span>{{$bebe->prix_article}}</span></td>
                                                <td class="cell">{{$bebe->created_at}}</td>
                                                <td class="cell">
